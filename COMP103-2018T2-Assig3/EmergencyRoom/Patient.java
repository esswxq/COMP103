...
public class Patient implements Comparable<Patient>{
    ...
    public int getPri() {return priority;}    //get priority of patient, use to compare
    ...
    public int compareTo(Patient other){
        /*# YOUR CODE HERE */
        if        (this.getPri()<other.getPri()||(this.getPri()==other.getPri())
                    &&this.getArrivalTime()<other.getArrivalTime()) {return -1;}  //this patient order first
        else if   (this.getPri()>other.getPri()||(this.getPri()==other.getPri())
                    &&this.getArrivalTime()>other.getArrivalTime()) {return  1;}  //orther patient order first
        else      {return  0;}   
    }
    ...
    public void makeRandomTreatments(){
        ...
        for (int i=0; i<n; i++){
            ...
            if (num<0.05){
                ...
                treatments.add("Children's room");           //expand a new department
                treatmentTimes.add(randomTreatmentTime(50));
            }
        }
